 ...
 *  }
 */
rhcp.addBandmate = function addBandmate(name, instrument) {
  this[name] = instrument;
}

rhcp.removeBandmate = function removeBandmate(name) {
  delete this[name];
}

rhcp.bandPlay = function bandPlay(){
...
rhcp.addBandmate("Anthony","Vocals");
rhcp.addBandmate("Flea","Bass");
rhcp.addBandmate("Chad","Drums");
rhcp.addBandmate("Josh","Guitar");
// rhcp.removeBandmate("Josh");
// console.log("RHCP: ",rhcp);
rhcp.bandPlay();
